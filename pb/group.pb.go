...
type Group struct {
	...
	SpecialityId  string `protobuf:"bytes,9,opt,name=speciality_id,json=specialityId,proto3" json:"speciality_id,omitempty"`
...
func (x *Group) GetSpecialityId() string {
	if x != nil {
...
var file_pb_group_proto_rawDesc = []byte{
	...
	0x74, 0x79, 0x5f, 0x69, 0x64, 0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x73, 0x70, 0x65,
